...
/*************************************************************/
WiFiClient espClient200;
PubSubClient client(espClient200);
...
#define WIFI_SSID "ahmedaly"
#define WIFI_PASSWORD "ahly0100100100AH@@"

/* 2. Define the API Key */
#define API_KEY "AIzaSyAB15k3SR5rwfVV0RFA3vbOvA0nrce7ka8"

/* 3. Define the user Email and password that alreadey registerd or added in your project */
#define USER_EMAIL "salah.ali1000@gmail.com"
#define USER_PASSWORD "ahly0100100100AH@"

/* 4. Define the Firebase storage bucket ID e.g bucket-name.appspot.com */
#define STORAGE_BUCKET_ID "fota-e0cde.appspot.com"
...
void reconnect() {
  while (!client.connected()) {
    ...
    if (client.connect("espClient200")) {
...
void loop()
{
    ...
    if (Firebase.ready() && !taskCompleted)
    {
        ...
        if (!Firebase.Storage.download(&fbdo, STORAGE_BUCKET_ID /* Firebase Storage bucket id */, "TestBootloader1.bin" /* path of remote file stored in the bucket */, "/updat.bin" /* path to local file */, mem_storage_type_flash /* memory storage type, mem_storage_type_flash and mem_storage_type_sd */, fcsDownloadCallback /* callback function */))
